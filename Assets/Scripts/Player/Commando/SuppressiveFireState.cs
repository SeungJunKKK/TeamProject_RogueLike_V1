...
{
    public class SuppressiveFireState : PlayerAttackState
    {
        private int m_CurrentShotCount = 0;
        private bool m_IsSingleMode; 

        public SuppressiveFireState(PlayerController player, float duration)
        ...
        public override void Enter()
        {
            ...
            if (m_IsSingleMode)
            {
                ...
                m_Player.Anim.Play("SuppressiveFire_Single");
            }
            else
            {
                m_Player.Anim.Play("SuppressiveFire_Both"); 
            }
        }
